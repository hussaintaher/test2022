...
export default function Example() {
    const [navigation, setNavigation] = useState([
        ...
        { name: 'العروض', href: '#', current: false },
        { name: 'الاطباء', href: '#', current: false },
        { name: 'العيادات', href: '#', current: false },
        { name: 'المستشفيات الجامعية', href: '#', current: false },
        { name: 'نبذة عنا', href: '#', current: false },
            ...
            <>
                ...
                <div className="flex flex-row-reverse items-center justify-between h-16">
                  <div className="flex flex-row-reverse items-center">
                    ...
                    <div className="hidden lg:block">
                      <div className="ml-0 flex flex-row-reverse items-baseline space-x-4">
                        {navigation.map((item) => (
                          <a
                            key={item.name}
                            href={item.href}
              ...
              <Disclosure.Panel className="md:hidden">
                ...
                <div className="pt-4 pb-3 border-t border-gray-700">
                  ...
                  <div className="mt-3 px-2 text-center space-y-1">
                    {userNavigation.map((item) => (
                      <Disclosure.Button
                        key={item.name}
                        as="a"
